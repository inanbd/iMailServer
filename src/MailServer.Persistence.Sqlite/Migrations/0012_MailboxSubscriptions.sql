-- =============================================================================
-- AetherMail Server - IMAP subscription list and UIDVALIDITY high-water mark (SQLite)
-- Milestone 10
--
-- Purely additive: two new tables, an index, and seeds from the data they
-- supersede or summarise. No existing table is altered, so this carries no
...
-- -----------------------------------------------------------------------------
CREATE TABLE MailboxSubscriptions (
...
CREATE INDEX IX_MailboxSubscriptions_Mailbox
    ON MailboxSubscriptions (MailboxId);
...
-- -----------------------------------------------------------------------------
CREATE TABLE MailboxUidValidity (
    MailboxId TEXT    NOT NULL PRIMARY KEY,
...
-- them already used.
INSERT INTO MailboxUidValidity (MailboxId, Highest)
